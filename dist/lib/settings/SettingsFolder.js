...
class SettingsFolder extends Map {
    ...
    async _resolveEntry(context) {
        ...
        if (context.entry.array) {
            return (await Promise.all(values.map((value) => serializer.resolve(value, context)))).filter((value) => value !== null);
        }
 ...
 */
var SettingsExistenceStatus;
(function (SettingsExistenceStatus) {
    /**
     * The settings has not been synchronized, in this status, any update operation will error. To prevent this, call
     * `settings.sync()` first.
     */
    SettingsExistenceStatus[SettingsExistenceStatus["Unsynchronized"] = 0] = "Unsynchronized";
    /**
     * The settings entry exists in disk, any disk operation will be done through an update.
     */
    SettingsExistenceStatus[SettingsExistenceStatus["Exists"] = 1] = "Exists";
    /**
     ...
     */
    SettingsExistenceStatus[SettingsExistenceStatus["NotExists"] = 2] = "NotExists";
})(SettingsExistenceStatus = exports.SettingsExistenceStatus || (exports.SettingsExistenceStatus = {}));
/**
...
(function (ArrayActions) {
     ...
     * // -> ['hello', 'world']
     */
    ArrayActions["Overwrite"] = "overwrite";
