...
export declare abstract class SQLProvider extends Provider {
     ...
     */
    abstract create(table: string, entry: string, data: object): Promise<unknown>;
    /**
     ...
     */
    abstract update(table: string, entry: string, data: object): Promise<unknown>;
    /**
     ...
     */
    abstract replace(table: string, entry: string, data: object): Promise<unknown>;
    /**
