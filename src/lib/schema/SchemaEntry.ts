...
export class SchemaEntry {
	...
	public constructor(parent: Schema | SchemaFolder, key: string, type: string, options: SchemaEntryOptions = {}) {
		...
		this.array =
			typeof options.array === 'undefined' ? (typeof options.default === 'undefined' ? false : Array.isArray(options.default)) : options.array;
	...
	public _check(): void {
		...
		// Check limits
		if (this.minimum !== null && !isNumber(this.minimum))
			throw new TypeError(`[KEY] ${this.path} - Parameter 'minimum' must be a number or null.`);
		if (this.maximum !== null && !isNumber(this.maximum))
